...
export default function Footer() {
    return (
        <footer className="dark bg-background border-t border-border pt-16 pb-8 text-foreground">
            <div className="w-full px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-12 md:mb-16 text-center md:text-left">
                    ...
                    {/* Platform Links */}
                    <div>
                        <h4 className="font-bold text-foreground mb-6">Plataforma</h4>
                ...
                {/* Bottom Bar */}
                <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground text-center md:text-left">
                    <p>© {new Date().getFullYear()} PasseDemanda. Todos os direitos reservados.</p>
                    <div className="flex gap-8">
                        <a href="#" className="hover:text-foreground transition-colors">Privacidade</a>
                        <a href="#" className="hover:text-foreground transition-colors">Termos</a>
                        <a href="#" className="hover:text-foreground transition-colors">Mapa do Site</a>
                    </div>
                </div>
            </div>
        </footer>
